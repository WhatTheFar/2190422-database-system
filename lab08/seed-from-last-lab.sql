...
ALTER TABLE `Takes`
  ...
  ADD CONSTRAINT `takes_ibfk_2` FOREIGN KEY (`cid`,`sect_id`,`semester`,`year`) REFERENCES `Section` (`cid`, `sect_id`, `semester`, `year`) ON DELETE cascade ON UPDATE cascade;
...
ALTER TABLE `Teaches`
  ...
  ADD CONSTRAINT `teaches_ibfk_2` FOREIGN KEY (`cid`,`sect_id`,`semester`,`year`) REFERENCES `Section` (`cid`, `sect_id`, `semester`, `year`) ON DELETE cascade ON UPDATE cascade;
COMMIT;
