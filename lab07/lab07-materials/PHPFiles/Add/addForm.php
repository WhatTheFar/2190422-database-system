...
<table width="600" border="1">
  ...
  ?>
  <tr>
    <td><div align="center"><input type="text" name="txtCourseID<?php echo $i;?>" size="8"></div></td>
    <td><input type="text" name="txtTitle<?php echo $i;?>" size="20"></td>
    <td><input type="text" name="txtDeptName<?php echo $i;?>" size="20"></td>
    <td><div align="center"><select name="txtCredits<?php echo $i;?>" size="1">
